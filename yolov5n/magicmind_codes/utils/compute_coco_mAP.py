...
def get_args():
    ...
    parser.add_argument("--ann_dir", dest = "ann_dir", help =
                        ...
                        default = './',type = str)
    parser.add_argument("--output_json", dest = "output_json", help =
                        "output_json",
                        default = './',type = str)
    ...
    parser.add_argument("--image_num", dest = "image_num", help = "image number", default = 5000, type = int)
...
if __name__ == "__main__":
    ...
    input_json_file = args.output_json
